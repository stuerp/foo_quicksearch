...
#define STR_COMPONENT_BASENAME      "foo_quicksearch"
#define STR_COMPONENT_FILENAME      STR_COMPONENT_BASENAME ".dll"
#define STR_COMPONENT_COPYRIGHT     "Copyright (c) 2022-2023. All rights reserved."
#define STR_COMPONENT_COMMENTS      "Written by P. Stuer"
#define STR_COMPONENT_DESCRIPTION   "Creates playlists based on quick search patterns."
